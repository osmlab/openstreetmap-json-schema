...
```javascript
{
    ...
    "nodes": [
        // An example of a node.
        {
            ...
            // SHOULD use a 64-bit integer for this.
            "id": 1,
            ...
            // was modified in. Implementations SHOULD use a 64-bit integer
            // for this.
            "changeset": 1234,
        ...
        // Repeat for additional nodes. Any two nodes MUST NOT have the same 
        // ID and version.
    ],
    ...
    "ways": [
        // An example of a way
        {
            // REQUIRED. The positive integer ID of the way. Implementations
            // SHOULD use a 64-bit integer for this.
            "id": 1,
            ...
            // present in the list of nodes in the file. Implementations SHOULD
            // use 64-bit integers for node references.
            "nds": [
                1,
                2,
                3
        ...
        // Repeat for additional ways. Any two ways MUST NOT have the same
        // ID and version.
    ],
    ...
    "relations": [
        ...
        {
            // REQUIRED. The positive integer ID of the relation. Implementations
            // SHOULD use a 64-bit integer for this.
            "id": 1,
            ...
            "members": [
                {
                    ...
                    // Implementations SHOULD use a 64-bit integer for this.
                    "ref": 1,
        ...
        // Repeat for additional relations. Any two relations MUST NOT have the same
        // ID and version.
    ]
}
```
